...
export const CURRENCY_DATA = {
  usdt: {
    ...
    icon: '/icons/currencies/usdt.webp',
  },
  btc: {
    name: 'Bitcoin',
    symbol: 'BTC',
    ...
    icon: '/icons/currencies/btc.webp',
  },
  eth: {
    name: 'Ethereum',
    symbol: 'ETH',
    ...
    icon: '/icons/currencies/eth.webp',
  },
  usdc: {
    name: 'USD Coin',
    symbol: 'USDC',
    ...
    bgLight: 'bg-blue-50',
    borderColor: 'border-blue-200',
    icon: '/icons/currencies/usdc.webp',
  },
  trx: {
    name: 'TRON',
    symbol: 'TRX',
    ...
    icon: '/icons/currencies/trx.webp',
  },
...
export const PAYMENT_METHOD_DATA = {
  ...
  googlepay: {
    ...
    borderColor: 'border-blue-200',
    textColor: 'text-blue-700',
    icon: '/icons/methods/googlepay.webp',
  },
  alipay: {
    name: 'Alipay',
